<#
Um script que solicita a entrada de 3 números e:
- calcula o produto do dobro do primeiro numero com metade do segundo;
...
#Realiza os cálculos
[float]$x = [math]::Round((2*$a)*($b/2), 2)
[float]$y = [math]::Round((3*$a)+$c, 2)
[float]$z = [math]::Round([math]::Pow($c, 3), 2)
